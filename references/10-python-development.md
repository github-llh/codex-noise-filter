...
先执行 `01-global-engineering-rules.md#跨技术栈环境与命令`，再按 `14-environment-cache-by-stack.md#python-环境缓存` 读取/复用 `.codex/local-environment.json`、Python 版本、虚拟环境、管理器和项目命令。
